	...
	<div class="main-wrapper">
		<div class="header">
			<div class="header-left">
				<a href="index.html" class="logo"> <img src="assets/img/user.png" width="50" height="70" alt="logo"> <span class="logoclass">KLINIK HEWAN </span> </a>
				...
				<div class="page-header">
					<div class="row">
						<div class="col-sm-12 mt-5">
							<h3 class="page-title mt-3">Selamat Datang Di Website UD Jati Makmur</h3>
							<ul class="breadcrumb">
