...
<head>
    ...
    <link href="{{ asset('assets2/sweetalert2/sweetalert2.min.css') }}" rel="stylesheet">
    ...
    {{--<link rel="stylesheet" href="{{ asset('assets2/dist/css/skins/skin-blue.min.css')}} ">--}}
